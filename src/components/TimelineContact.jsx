...
const timeline = [
  {
    ...
    org: 'Your University',
    period: '2022 — Present',
    details: 'Core courses: DSA, OS, DBMS, Computer Networks, AI/ML. Activities: Coding club, hackathons.'
  },
  {
    title: 'Software Engineering Intern',
    org: 'Tech Startup',
    period: 'Summer 2024',
    details: 'Built internal dashboards and automation scripts. Improved performance and DX.'
  },
  {
    title: 'Open Source Contributor',
    org: 'Various',
    period: '2023 — Present',
    details: 'Contributed bug fixes and features to frontend libraries and ML repos.'
  },
];
            ...
            <div className="relative border-l border-white/15 pl-6">
              {timeline.map((item, idx) => (
                ...
                >
                  ...
                  <p className="text-sm text-white/70">{item.org} · {item.period}</p>
                  <p className="mt-2 text-white/80">{item.details}</p>
                </motion.div>
              ))}
            </div>
          </div>
  ...
  return (
    <div id="contact" className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 shadow-xl shadow-black/20 backdrop-blur-md">
      ...
      >
        ...
        <button type="submit" className="w-full rounded-lg bg-gradient-to-r from-indigo-500 to-fuchsia-500 px-5 py-3 font-semibold text-white transition hover:brightness-110">Send Message</button>
      </form>
